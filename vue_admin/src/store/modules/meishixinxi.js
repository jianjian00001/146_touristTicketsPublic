...
const actions = {
    selectAll(
        ...
        return new Promise((resolve, reject) => {
            if (content.state.status == 0) {
                ...
                http.get("/api/meishixinxi/selectAll").then(
                    (res) => {
                        if (res.code == 0) {
    ...
    findById(content, id) {
        return new Promise((resolve, reject) => {
            http.get("/api/meishixinxi/findById", { id }).then((res) => {
                if (res.code == 0) {
                    resolve(res.data);
                } else {
                    reject(res.msg);
    ...
    filter(content, data) {
        return new Promise((resolve, reject) => {
            http.post("/api/meishixinxi/filter", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    query(content, data) {
        // 分页查询数据
        return new Promise((resolve, reject) => {
            http.post("/api/meishixinxi/selectPages", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    update(content, data) {
        // 更新数据
        return new Promise((resolve, reject) => {
            http.post("/api/meishixinxi/update", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    insert(content, data) {
        // 插入数据
        return new Promise((resolve, reject) => {
            http.post("/api/meishixinxi/insert", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    delete(content, data) {
        // 删除数据
        return new Promise((resolve, reject) => {
            http.post("/api/meishixinxi/delete", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {

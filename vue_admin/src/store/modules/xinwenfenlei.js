...
const actions = {
    ...
    findById(content, id) {
        return new Promise((resolve, reject) => {
            if (content.state.objLists[id]) {
                resolve(formData(content.state.objLists[id]));
            } else {
    ...
    filter(content, data) {
        return new Promise((resolve, reject) => {
            http.post("/api/xinwenfenlei/filter", JSON.stringify(data)).then(
                (res) => {
                    if (res.code == 0) {
                        resolve(res);
                    } else {
    ...
    query(content, data) {
        return new Promise((resolve, reject) => {
            http.post("/api/xinwenfenlei/selectPages", data).then(
                (res) => {
                    if (res.code == 0) {
                        resolve(res);
                    } else {
    ...
    update(content, data) {
        return new Promise((resolve, reject) => {
            http.post("/api/xinwenfenlei/update", JSON.stringify(data)).then(
                (res) => {
                    if (res.code == 0) {
                        if (content.state.status == 0) {
    ...
    insert(content, data) {
        return new Promise((resolve, reject) => {
            http.post("/api/xinwenfenlei/insert", JSON.stringify(data)).then(
                (res) => {
                    if (res.code == 0) {
                        if (content.state.status == 0) {
                            content.dispatch("selectAll");
    ...
    delete(content, data) {
        return new Promise((resolve, reject) => {
            http.post("/api/xinwenfenlei/delete", JSON.stringify(data)).then(
                (res) => {
                    if (res.code == 0) {
                        if (content.state.status == 0) {
                            content.dispatch("selectAll");
